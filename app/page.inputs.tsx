import { FaCodepen, FaListUl } from "react-icons/fa6"
...
import {
  ...
  BadgeLeftIcon,
  BadgeRightIcon,
} from "@/components/not-done/badge"
import {
  Menubar,
  MenubarContent,
  MenubarItem,
        ...
        cardComponent: (
          <div>
            <div className="flex flex-wrap gap-4">
              <div
                className={
                  "text-caption text-[var(--color-brand-foreground2-rest)]"
                }
              >
                Texto exemplo
              </div>
            ...
            <Divider
              ...
              align="start"
              className={
                "py-[var(--space-size-320)] text-[var(--color-neutral-foreground2-rest)]"
              }
            >
              Danger
            </Divider>
            ...
            <div className="flex flex-wrap gap-4">
              ...
              <Badge variant={"brandDangerOutline"}>Danger Outline</Badge>
              <Badge variant={"brandDangerSubtle"}>Danger Subtle</Badge>
              <Badge variant={"brandDangerFilled"}>
            ...
            <div className="flex flex-wrap gap-4">
              ...
              <Badge variant={"brandWarningOutline"}>Danger Outline</Badge>
              <Badge variant={"brandWarningSubtle"}>Danger Subtle</Badge>
              <Badge variant={"brandWarningFilled"}>
                {/*<BadgeCenterIcon icon={FaCodepen} />*/}
              </Badge>
            </div>
            ...
            <div className="flex flex-wrap gap-4">
              ...
              <Badge variant={"brandSuccessOutline"}>Danger Outline</Badge>
              <Badge variant={"brandSuccessSubtle"}>Danger Subtle</Badge>
              <Badge variant={"brandSuccessFilled"}>
                {/*<BadgeCenterIcon icon={FaCodepen} />*/}
              </Badge>
            </div>
            ...
            <div className="flex flex-wrap gap-4">
              ...
              <Badge variant={"brandImportantOutline"}>Danger Outline</Badge>
              <Badge variant={"brandImportantSubtle"}>Danger Subtle</Badge>
              <Badge variant={"brandImportantFilled"}>
                {/*<BadgeCenterIcon icon={FaCodepen} />*/}
              </Badge>
            </div>
            ...
            <div className="flex flex-wrap gap-4">
              ...
              <Badge variant={"brandInformativeOutline"}>Danger Outline</Badge>
              <Badge variant={"brandInformativeSubtle"}>Danger Subtle</Badge>
              <Badge variant={"brandInformativeFilled"}>
                {/*<BadgeCenterIcon icon={FaCodepen} />*/}
              </Badge>
            </div>
            ...
            <div className="rounded-large flex flex-wrap gap-4 bg-[var(--color-neutral-background-static)] p-[var(--space-size-160)]">
              ...
              <Badge variant={"brandSubtleOutline"}>Danger Outline</Badge>
              <Badge variant={"brandSubtleSubtle"}>Danger Subtle</Badge>
              <Badge variant={"brandSubtleFilled"}>
                {/*<BadgeCenterIcon icon={FaCodepen} />*/}
              </Badge>
            </div>
          ...
          <div>
            ...
            >
              <AccordionItem value="1">
                <AccordionTrigger>Accordion Header 1</AccordionTrigger>
                <AccordionContent>
                  <div>Accordion Panel 1</div>
                </AccordionContent>
              </AccordionItem>
              <AccordionItem value="2">
                <AccordionTrigger>Accordion Header 2</AccordionTrigger>
                <AccordionContent>
                  <div>Accordion Panel 2</div>
                </AccordionContent>
              </AccordionItem>
              <AccordionItem value="3">
                <AccordionTrigger>Accordion Header 3</AccordionTrigger>
                <AccordionContent>
