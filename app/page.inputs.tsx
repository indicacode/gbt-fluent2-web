import {FaListUl, FaCodepen, FaPersonCircleCheck} from "react-icons/fa6"
...
export const components = [
    ...
    {
        header: "Badge",
        subText: "A badge is a visual indicator that communicates a status or description of an associated component." +
            " They use short text, color, and icons for quick recognition and are placed near the relavant content.",
        cards: [
            {
                cardHeader: "Variants",
                cardSubtext: (
                ...
                cardComponent: (
                    <div>
                        <div className="flex flex-wrap gap-4">
                            <div className={"text-[var(--color-brand-foreground2-rest)] text-caption"}>
                                Texto exemplo
                            </div>

                            <Badge variant={"brandFilled"}>
                                <BadgeRightIcon icon={FaListUl}/>
                                BADGE FILLED
                            </Badge>
                            <Badge variant={"brandTint"}>
                                <BadgeLeftIcon icon={FaListUl}/>
                                BADGE TEXT
                            </Badge>
                        ...
                        <Divider variant="subtle" orientation="horizontal" align="start"
                                 className={"py-[var(--space-size-320)] text-[var(--color-neutral-foreground2-rest)]"}>
                            Danger
                        </Divider>

                        <div className="flex flex-wrap gap-4">
                            <Badge variant={"brandDangerFilled"}>
                                <BadgeLeftIcon icon={FaCodepen}/>
                                Danger Filled
                            </Badge>
                            <Badge variant={"brandDangerTint"}>
                                <BadgeLeftIcon icon={FaCodepen}/>
                                Danger Tint
                            </Badge>
                            <Badge variant={"brandDangerOutline"}>
                                Danger Outline
                            </Badge>
                            <Badge variant={"brandDangerSubtle"}>
                                Danger Subtle
                            </Badge>
                            <Badge variant={"brandDangerFilled"}>
                        ...
                        <div className="flex flex-wrap gap-4">
                            ...
                            <Badge variant={"brandWarningTint"}>
                                <BadgeLeftIcon icon={FaCodepen}/>
                                Danger Tint
                            </Badge>
                            <Badge variant={"brandWarningOutline"}>
                                Danger Outline
                            </Badge>
                            <Badge variant={"brandWarningSubtle"}>
                                Danger Subtle
                            </Badge>
                            <Badge variant={"brandWarningFilled"}>
                                {/*<BadgeCenterIcon icon={FaCodepen} />*/}
                        ...
                        <div className="flex flex-wrap gap-4">
                            ...
                            <Badge variant={"brandSuccessTint"}>
                                <BadgeLeftIcon icon={FaCodepen}/>
                                Danger Tint
                            </Badge>
                            <Badge variant={"brandSuccessOutline"}>
                                Danger Outline
                            </Badge>
                            <Badge variant={"brandSuccessSubtle"}>
                                Danger Subtle
                            </Badge>
                            <Badge variant={"brandSuccessFilled"}>
                                {/*<BadgeCenterIcon icon={FaCodepen} />*/}
                        ...
                        <div className="flex flex-wrap gap-4">
                            ...
                            <Badge variant={"brandImportantTint"}>
                                <BadgeLeftIcon icon={FaCodepen}/>
                                Danger Tint
                            </Badge>
                            <Badge variant={"brandImportantOutline"}>
                                Danger Outline
                            </Badge>
                            <Badge variant={"brandImportantSubtle"}>
                                Danger Subtle
                            </Badge>
                            <Badge variant={"brandImportantFilled"}>
                                {/*<BadgeCenterIcon icon={FaCodepen} />*/}
                        ...
                        <div className="flex flex-wrap gap-4">
                            ...
                            <Badge variant={"brandInformativeTint"}>
                                <BadgeLeftIcon icon={FaCodepen}/>
                                Danger Tint
                            </Badge>
                            <Badge variant={"brandInformativeOutline"}>
                                Danger Outline
                            </Badge>
                            <Badge variant={"brandInformativeSubtle"}>
                                Danger Subtle
                            </Badge>
                            <Badge variant={"brandInformativeFilled"}>
                                {/*<BadgeCenterIcon icon={FaCodepen} />*/}
                        ...
                        <div className="flex flex-wrap gap-4 bg-[var(--color-neutral-background-static)] p-[var(--space-size-160)] rounded-large">
                            <Badge variant={"brandSubtleFilled"}>
                                <BadgeLeftIcon icon={FaCodepen}/>
                                Danger Filled
                            </Badge>
                            <Badge variant={"brandSubtleTint"}>
                                <BadgeLeftIcon icon={FaCodepen}/>
                                Danger Tint
                            </Badge>
                            <Badge variant={"brandSubtleOutline"}>
                                Danger Outline
                            </Badge>
                            <Badge variant={"brandSubtleSubtle"}>
                                Danger Subtle
                            </Badge>
                            <Badge variant={"brandSubtleFilled"}>
                                {/*<BadgeCenterIcon icon={FaCodepen} />*/}
        ...
        cards: [
            {
                ...
                cardComponent: (
                    <Drawer defaultOpen={true} position="bottom">
                        <DrawerTrigger
                            className="dark:text-whitesmoke active:gray-200 bg-brand-primary active:border-brand-secondary rounded-md px-4 py-1 text-white duration-400 hover:bg-[#115EA3] active:bg-[#0C3B5E] disabled:bg-[#F0F0F0] disabled:text-black data-[selected=true]:before:bg-white">
                            Open drawer
                        </DrawerTrigger>
                ...
                cardComponent: (
                    <div>
                        ...
                        <Drawer defaultOpen={false} position="right">
                            <DrawerTrigger
                                className="dark:text-whitesmoke active:gray-200 bg-brand-primary active:border-brand-secondary ml-2 rounded-md px-4 py-1 text-white duration-400 hover:bg-[#115EA3] active:bg-[#0C3B5E] disabled:bg-[#F0F0F0] disabled:text-black data-[selected=true]:before:bg-white">
                        ...
                        <Drawer defaultOpen={false} position="left">
                            <DrawerTrigger
                                className="dark:text-whitesmoke active:gray-200 bg-brand-primary active:border-brand-secondary mt-2 rounded-md px-4 py-1 text-white duration-400 hover:bg-[#115EA3] active:bg-[#0C3B5E] disabled:bg-[#F0F0F0] disabled:text-black data-[selected=true]:before:bg-white">
                ...
                cardComponent: (
                    <div className={"flex flex-row"}>
                        ...
                        <Avatar status="busy" size="sm">
                            ...
                            <AvatarImage
                                src="https://images.pexels.com/photos/23909935/pexels-photo-23909935/free-photo-of-moda-tendencia-amor-mulher.jpeg"/>
                        </Avatar>
                        <Avatar status={"online"} size="sm">
