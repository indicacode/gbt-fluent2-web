...
export default function Page() {
    ...
    return (
        <div
            className="flex h-[100%] min-h-screen w-full grow flex-row bg-linear-to-r from-white to-slate-200 transition-colors dark:from-slate-950 dark:to-zinc-950">
      <span
          className={`w-full ${isMobile && isCollapsed ? "max-w-14" : "max-w-44"} bg-[var(--color-neutral-background3-rest)]`}
      />
            <div
            ...
            <main className="flex min-h-full w-full items-center justify-center py-12 bg-[var(--color-neutral-background1-rest)]">
                                ...
                                {cards.map(
                                    ({cardHeader, cardSubtext, cardComponent}, idx: number) => (
                                        <Fragment key={idx}>
                                            ...
                                            <div
                                                className="relative flex min-w-fit overflow-hidden rounded-sm border border-zinc-400 p-4 text-slate-950 shadow-sm dark:border-zinc-200 bg-[var(--color-neutral-background2-rest)] dark:text-slate-50">
                                                {cardComponent}
                                            </div>
                                        </Fragment>
                                    )
