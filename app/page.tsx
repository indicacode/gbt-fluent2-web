          ...
          <div className="flex w-full flex-col gap-4">
            ...
            >
              ...
              <CardContent className="mt-8 flex w-full flex-col items-center justify-between  lg:mt-0  lg:flex-row">
                ...
                <div className="mt-8  flex w-full flex-col items-center justify-center gap-5 lg:mt-0">
                  <h1 className=" font-Segoe text-2xl font-semibold">
                    Disabled
                  </h1>
            ...
            <Card id={"select"} className={" lg:w-[80vw] dark:bg-gray-800"}>
              <CardHeader>
                ...
                <CardDescription>
                  A component for a small list to select something or some
                  state!
                </CardDescription>
              </CardHeader>
            ...
            <Card id={"drawer"} className={" lg:w-[80vw] dark:bg-gray-800  "}>
              <CardHeader>
                ...
                <CardDescription>
                  A component for a drawer to pop out of the bottom of the
                  screen for content to be displayed
                </CardDescription>
              </CardHeader>
              <CardContent className={""}>
                <Drawer>
                  ...
                  <DrawerContent>
                    ...
                    >
                      ...
                      <DrawerDescription className={" text-slate-50"}>
                        Grbtec`s Property Management System, is soon to come!
                        for now, try and track this little ball for as long as
                        you can!
                      </DrawerDescription>
