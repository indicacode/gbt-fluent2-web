...
describe("Card Component", () => {
  ...
  it("should handle the `pressed` state when variant is outline", () => {
    ...
    expect(card).toHaveClass(
      " relative h-fit w-full overflow-hidden rounded-md border border-gray-300 shadow-none dark:border-zinc-200 dark:text-slate-50 dark:hover:bg-slate-950 flex flex-col\n"
    )
