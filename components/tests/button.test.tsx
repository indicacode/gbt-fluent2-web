...
describe("Button component", () => {
    ...
    it("applies the correct classes based on variant, size, and shape", () => {
        const { getByRole } = render(<Button variant="secondary" size="lg" shape="circular">Click me</Button>);
        const button = getByRole("button");
    ...
    it("renders with an icon when provided", () => {
        const { getByRole } = render(<Button icon={<span>🔥</span>}>Click me</Button>);
        const button = getByRole("button");
    ...
    it("does not toggle selected state when disabled", () => {
        const { getByRole } = render(<Button toggle isDisabled>Click me</Button>);
        const button = getByRole("button");
    ...
    it("does not respond to clicks when disabled", () => {
        ...
        const { getByRole } = render(<Button isDisabled onClick={handleClick}>Click me</Button>);
        const button = getByRole("button");
